import { Body, BaseCircle, BaseLine, BasePolygon, SATPolygon, Vector } from './model';
 ...
 * @param circle
 */
export declare function polygonInCircle(polygon: BasePolygon, circle: BaseCircle): boolean;
 ...
 * @param circle
 */
export declare function pointOnCircle(point: Vector, circle: BaseCircle): boolean;
/**
 * https://stackoverflow.com/a/68197894/1749528
 *
 * @param circle1
 * @param circle2
 */
export declare function circleInCircle(circle1: BaseCircle, circle2: BaseCircle): boolean;
/**
 * https://stackoverflow.com/a/68197894/1749528
 *
 * @param circle
 * @param polygon
 */
export declare function circleInPolygon(circle: BaseCircle, polygon: Polygon): boolean;
/**
 * https://stackoverflow.com/a/68197894/1749528
 *
 * @param circle
 * @param polygon
 */
export declare function circleOutsidePolygon(circle: BaseCircle, polygon: Polygon): boolean;
/**
 ...
 * @param circle
 */
export declare function intersectLineCircle(line: BaseLine, { pos, r }: BaseCircle): Vector[];
/**
 ...
 * @param line2
 */
export declare function intersectLineLineFast(line1: BaseLine, line2: BaseLine): boolean;
/**
 ...
 * @param line2
 */
export declare function intersectLineLine(line1: BaseLine, line2: BaseLine): Vector | undefined;
/**
 ...
 */
export declare function intersectPolygonPolygon(polygonA: BasePolygon, polygonB: BasePolygon): Vector[];
/**
 ...
 */
export declare function intersectLinePolygon(line: BaseLine, { calcPoints, pos }: BasePolygon): Vector[];
/**
 * @param circle1
 * @param circle2
 */
export declare function intersectCircleCircle(circle1: BaseCircle, circle2: BaseCircle): Vector[];
