    ...
    benchmark
        ...
        console.table(benchmark.tasks.map(({ name, result }) => {
            ...
            return result
                ? {
                    'Task Name': name,
                    'Average Time (s)': parseFloat(((_a = result.latency.min) !== null && _a !== void 0 ? _a : 0).toFixed(3)),
                    'Standard Deviation (s)': parseFloat(((_b = result.latency.sem) !== null && _b !== void 0 ? _b : 0).toFixed(3)),
                    hz: parseFloat(((_c = result.throughput.mean) !== null && _c !== void 0 ? _c : 0).toFixed(3)),
                    'p99 (s)': parseFloat(((_d = result.latency.p99) !== null && _d !== void 0 ? _d : 0).toFixed(3)),
                    'p995 (s)': parseFloat(((_e = result.latency.p995) !== null && _e !== void 0 ? _e : 0).toFixed(3))
                }
                : { name };
        }));
    })
